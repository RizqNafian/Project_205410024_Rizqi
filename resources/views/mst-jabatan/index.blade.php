...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Tabel Jabatan</li>
    </ol>
 </nav>
@stop
@section('css')
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="col-12 table-responsive">
                        <table class="table table-bordered " id="mst_jabatan_datatable">
                            <thead>
                                <tr>
                                    <th width="10px">No</th>
                                    <th>Nama Jabatan</th>
...
<script type="text/javascript">
    $(function () {
        var table = $('#mst_jabatan_datatable').DataTable({
            "searching": true,
            processing: true,
            serverSide: true,
            ajax: "{{ route('mst-jabatan.index') }}",
            columns: [
