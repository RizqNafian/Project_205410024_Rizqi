<div class="box box-info padding-1">
    <div class="box-body">
        ...
        <div class="form-row">
            ...
            ['class' => 'col-sm-3 col-form-label','style'=>'font-weight:bold;']) }}
            <div class="col-sm-9">
                {{ Form::date('tanggal_lahir', $pegawai->tanggal_lahir, ['class' => 'form-control' .
        ...
        <div class="form-row">
            ...
            <div class="col-sm-9">
                ...
                <div class="invalid-feedback">:message</define_syslog_variables>') !!}</div>
            </div>
        <div class="form-row">
            ...
            <div class="form-row">
                ...
                <div class="form-row">
                    ...
                    <div class="col-sm-9">
                        ...
                        ($errors->has('mat_jabatan_id') ? 'is-invalid' : ''),
                        'placeholder' => '--- pilih ---']) }}
